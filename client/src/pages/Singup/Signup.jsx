  ...
  return (
    <form onSubmit={submit}>
      <div className={'relative'}>
        ...
        <div className={`relative flex flex-row h-screen custom-form`}>
              ...
              <div className={'py-8 w-[500px]'}>
                <div className={`flex flex-row border-primary p-2 input-wrapper`}>
                  ...
                  <input
                    ...
                    className={errors.name ? 'form-error' : null}
                  />
                </div>
                ...
                <div className={`flex flex-row my-5 input-wrapper`}>
                  ...
                  <input
                    ...
                    className={errors.mail ? 'form-error' : null}
                    name={'mail'}
                    {...register('mail')}/>
                </div>
                ...
                <div className={`flex flex-row my-5 input-wrapper`}>
                  ...
                  <input
                    ...
                    name={'phone'}
                    className={errors.phone ? 'form-error' : null}
                    {...register('phone')}/>
                </div>
                ...
                <div className={'flex justify-between my-5 input-wrapper'}>
                    ...
                    <input
                      ...
                      className={errors.zipCode ? 'form-error' : null}
                      name={'zipCode'}
                      {...register('zipCode')}
                    />
                </div>
                ...
                <div className={`flex justify-between my-5 input-wrapper`}>
                  ...
                  <input
                    ...
                    className={errors.city ? 'form-error' : null}
                    name={'city'}
                    {...register('city')}
                  />
                </div>
                ...
                <div className={`flex flex-row my-5 input-wrapper`}>
                  ...
                  <input
                    ...
                    className={errors.address ? 'form-error' : null}
                    name={'address'}
                    {...register('address')}/>
                </div>
