...
export default function Signup({openModal, isModalOpen, closeModal, initialValue}) {
  ...
  const submit = handleSubmit(async (user) => {
    const response = await addUser(user.name, user.mail, user.phone, user.zipCode, user.city, user.land, user.address, user.password, user.roles);
