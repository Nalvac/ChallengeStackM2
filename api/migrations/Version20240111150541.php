 ...
 */
final class Version20240111150541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer_transaction ADD CONSTRAINT FK_717C2ED9382ED4ED FOREIGN KEY (product_batch_id) REFERENCES product_batch (id) ON DELETE SET NULL');
